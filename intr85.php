...
<head>
    ...
    <link href="css1/default.css" rel="stylesheet" type="text/css" media="all" />
    <link href="css1/fonts.css" rel="stylesheet" type="text/css" media="all" />
...
<div id="header-wrapper">
    <div id="header" class="container">
        ...
        <div id="menu">
            <ul>
                <li class="{{Request :: path() === '/' ? 'Current page item' : ''}}"><a href="/" accesskey="1" title="">Homepage</a></li>
                ...
                <li>class="{{Request :: path() === 'careers' ? 'Current page item' : ''}}"<a href="#" accesskey="4" title="">Careers</a></li>
